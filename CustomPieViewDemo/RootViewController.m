...
#define RGB(r,g,b,_alpha) [UIColor colorWithRed:r/255.0 green:g/255.0 blue:b/255.0 alpha:_alpha]
...
- (void)loadPieChartView
{
    ...
    //内圆的半径
    chartView.innerCircleR = 30;
    //大圆的半径
    chartView.pieRadius = 60;
    //整体饼状图的背景色
    chartView.backgroundColor = RGB(240, 241, 242, 1.0);
